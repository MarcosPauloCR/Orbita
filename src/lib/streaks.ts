...
export const TROPHIES = [
  { days: 1, name: "Primeiro Sinal", icon: "🌑", iconKind: "spark" },
  { days: 2, name: "Lua Nova", icon: "🌑", iconKind: "moon-new" },
  { days: 3, name: "Primeira Lua", icon: "🌒", iconKind: "moon-crescent-waxing" },
  { days: 5, name: "Quarto Crescente", icon: "🌓", iconKind: "moon-quarter-waxing" },
  { days: 7, name: "Lua Cheia", icon: "🌕", iconKind: "moon-full" },
  { days: 10, name: "Lua Minguante", icon: "🌖", iconKind: "moon-gibbous-waning" },
  { days: 14, name: "Duas Semanas em Órbita", icon: "🌗", iconKind: "moon-quarter-waning-orbit" },
  { days: 21, name: "Três Semanas", icon: "🌘", iconKind: "moon-crescent-waning" },
  { days: 30, name: "Um Mês de Órbita", icon: "🪐", iconKind: "saturn" },
  { days: 45, name: "Chuva de Meteoros", icon: "☄️", iconKind: "meteor-shower" },
  { days: 60, name: "Dois Meses", icon: "🌠", iconKind: "shooting-star" },
  { days: 90, name: "Um Trimestre Girando", icon: "🛰️", iconKind: "satellite" },
  { days: 120, name: "Quatro Meses", icon: "✨", iconKind: "sparkle-cluster" },
  { days: 150, name: "Cinco Meses", icon: "🌌", iconKind: "nebula-heart" },
  { days: 180, name: "Meio Ano", icon: "🌙", iconKind: "moon-full-halo" },
  { days: 210, name: "Sete Meses", icon: "⭐", iconKind: "star-outline" },
  { days: 240, name: "Oito Meses", icon: "🌟", iconKind: "star-filled" },
  { days: 270, name: "Nove Meses", icon: "💫", iconKind: "star-rays" },
  { days: 300, name: "Dez Meses", icon: "🔭", iconKind: "telescope" },
  { days: 330, name: "Onze Meses", icon: "🌍", iconKind: "globe" },
  { days: 365, name: "Um Ano de Órbita", icon: "🏆", iconKind: "trophy-cup" },
  { days: 500, name: "Meio Milênio de Dias", icon: "👑", iconKind: "crown" },
  { days: 730, name: "Dois Anos", icon: "💎", iconKind: "gem" },
  { days: 1000, name: "Mil Sinais de Amor", icon: "🌈", iconKind: "rainbow" },
] as const;
